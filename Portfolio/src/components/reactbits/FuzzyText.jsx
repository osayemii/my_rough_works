...
const FuzzyText = ({
  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      // Use numericFontSize as a rough height if tightHeight acts up, else 0 works for top margin.
      const verticalMargin = Math.max(0, (numericFontSize - tightHeight)/2 + fuzzRange);
      canvas.width = offscreenWidth + horizontalMargin * 2;
      canvas.height = tightHeight + verticalMargin * 2 + 10; // add slight padding
      ctx.translate(horizontalMargin, verticalMargin + 5);
  ...
  return <canvas ref={canvasRef} className={className} style={{ display: 'inline-block', verticalAlign: 'middle', maxWidth: '100%' }} />;
};
